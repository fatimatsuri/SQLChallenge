...
group by
    geo;
select "In my opinion, I think the most efficient
store would be California based on the number of
clicks they received and the amount of revenue
they made. $235,237 with 310 clicks is a lot compared
to Texas' and New York's statistics. This is about $758.83
per click on average for California, $214.81 per click for
New York, and $40.97 per click for Texas. Thus, the store
in California is the most efficient."
